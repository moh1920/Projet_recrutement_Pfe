...
export class JobOffersComponent implements OnInit {
  ...
  loadOffers(): void {
    this.loading = true;
    this.offreService.getAllOffresSorted(this.currentPage, this.pageSize, 'postedDate')
      .subscribe({
        next: (response) => {
  ...
  applyFilters(): void {
    this.filteredOffers = this.allOffers.filter(offer => {
      ...
      const matchesSearch = !this.searchTerm ||
        ...
        (offer.speciality && offer.speciality.toLowerCase().includes(this.searchTerm.toLowerCase()));

      // Type filter
      const matchesType = this.selectedType === 'all' ||
        offer.type === this.selectedType;
      ...
      const matchesLevel = this.selectedLevel === 'all' ||
        offer.requiredLevel === this.selectedLevel;
    ...
    this.allOffers = [
      {
        ...
        description: 'Nous recherchons un enseignant passionné pour enseigner l\'IA et le Machine Learning à nos étudiants en cycle ingénieur.',
        department: 'Informatique',
        speciality: 'Intelligence Artificielle',
        type: 'Permanent',
        workload: 12,
        requiredLevel: 'Doctorat',
        modules: ['Machine Learning', 'Deep Learning', 'Computer Vision', 'Natural Language Processing'],
      ...
      },
      {
        ...
        description: 'Poste de vacataire pour enseigner les systèmes embarqués et l\'électronique numérique aux étudiants de 3ème année.',
      ...
      },
      {
        ...
        description: 'Recherche d\'un enseignant permanent pour modules de conception mécanique et fabrication additive.',
        department: 'Mécanique',
        speciality: 'Conception Mécanique',
        type: 'Permanent',
        workload: 10,
        requiredLevel: 'Doctorat',
        modules: ['CAO', 'Résistance des matériaux', 'Mécanique des fluides', 'Fabrication additive'],
      ...
      },
      {
        ...
        description: 'Enseignement de la finance d\'entreprise et comptabilité analytique pour étudiants en gestion.',
        department: 'Gestion',
        speciality: 'Finance',
        type: 'Vacataire',
        workload: 8,
      ...
      },
      {
        ...
        description: 'Enseignement des techniques BIM et modélisation architecturale pour cycle ingénieur civil.',
        department: 'Civil',
      ...
      },
      {
        ...
        description: 'Vacataire pour enseigner les réseaux informatiques et la cybersécurité aux étudiants de master.',
        department: 'Informatique',
