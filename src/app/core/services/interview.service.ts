...
export class InterviewService {
  ...
  getInterviewById(id: string): Observable<Interview> {
    return this.http.get<Interview>(`${this.API_URL}/${id}`).pipe(catchError(this.handleError));
  }
  ...
  getInterviewsWithFilters(filters: InterviewFilters): Observable<Interview[]> {
    ...
    return this.http
      .get<Interview[]>(`${this.API_URL}/filter`, { params })
  ...
  getInterviewsByDateRange(startDate: string, endDate: string): Observable<Interview[]> {
    ...
    return this.http
      .get<Interview[]>(`${this.API_URL}/date-range`, { params })
      .pipe(catchError(this.handleError));
  }
  ...
  getInterviewsByJuryMember(juryMemberId: string): Observable<Interview[]> {
    return this.http
      .get<Interview[]>(`${this.API_URL}/jury/${juryMemberId}`)
      .pipe(catchError(this.handleError));
  }
  ...
  getInterviewsByCandidate(candidateId: string): Observable<Interview[]> {
    return this.http
      .get<Interview[]>(`${this.API_URL}/candidate/${candidateId}`)
      .pipe(catchError(this.handleError));
  }
  ...
  getUpcomingInterviews(): Observable<Interview[]> {
    return this.http
      .get<Interview[]>(`${this.API_URL}/upcoming`)
      .pipe(catchError(this.handleError));
  }
  ...
  sendNotification(notificationData: NotificationData): Observable<any> {
    return this.http
      .post(`${this.API_URL}/notifications`, notificationData)
      .pipe(catchError(this.handleError));
  }
  ...
  sendReminder(interviewId: string, reminderType: 'email' | 'sms' | 'both'): Observable<any> {
    return this.http
      .post(`${this.API_URL}/${interviewId}/reminder`, { reminderType })
      .pipe(catchError(this.handleError));
  }
  ...
  sendBulkReminders(
    ...
    return this.http
      .post(`${this.API_URL}/reminders/bulk`, { interviewIds, reminderType })
      .pipe(catchError(this.handleError));
  }
  ...
  uploadAttachment(interviewId: string, file: File): Observable<Attachment> {
    ...
    return this.http.post<Attachment>(`${this.API_URL}/${interviewId}/attachments`, formData).pipe(
      tap(() => this.invalidateCache()),
      catchError(this.handleError)
    );
  }
  ...
  deleteAttachment(interviewId: string, attachmentId: string): Observable<void> {
    return this.http
      .delete<void>(`${this.API_URL}/${interviewId}/attachments/${attachmentId}`)
      .pipe(
        tap(() => this.invalidateCache()),
        catchError(this.handleError)
      );
  ...
  downloadAttachment(interviewId: string, attachmentId: string): Observable<Blob> {
    return this.http
      .get(`${this.API_URL}/${interviewId}/attachments/${attachmentId}/download`, {
        responseType: 'blob',
      })
      .pipe(catchError(this.handleError));
  }
  ...
  getStatistics(dateFrom?: string, dateTo?: string): Observable<InterviewStatistics> {
    ...
    return this.http
      .get<InterviewStatistics>(`${this.API_URL}/statistics`, { params })
      .pipe(catchError(this.handleError));
  }
  ...
  checkAvailability(
    date: string,
    juryIds?: string[]
  ): Observable<{ hour: string; available: boolean }[]> {
    ...
    return this.http
      .get<{ hour: string; available: boolean }[]>(`${this.API_URL}/availability`, { params })
      .pipe(catchError(this.handleError));
  }
  ...
  checkConflicts(
    ...
    return this.http
      .get<any[]>(`${this.API_URL}/conflicts`, { params })
      .pipe(catchError(this.handleError));
  }
  ...
  exportToExcel(interviews: Interview[], weekDays: CalendarDay[]): Observable<Blob> {
    ...
    return this.http
      .post(`${this.API_URL}/export/excel`, exportData, { responseType: 'blob' })
      .pipe(
  ...
  exportToPDF(interviews: Interview[], weekDays: CalendarDay[]): Observable<Blob> {
    ...
    return this.http.post(`${this.API_URL}/export/pdf`, exportData, { responseType: 'blob' }).pipe(
  ...
  exportToCSV(interviews: Interview[]): Observable<Blob> {
    return this.http
      .post(`${this.API_URL}/export/csv`, { interviews }, { responseType: 'blob' })
      .pipe(
  ...
  exportToICal(interviews: Interview[]): Observable<Blob> {
    return this.http
      .post(`${this.API_URL}/export/ical`, { interviews }, { responseType: 'blob' })
      .pipe(
  ...
  generateMeetingLink(
    ...
    return this.http
      .post<{ link: string }>(`${this.API_URL}/${interviewId}/generate-meeting`, { provider })
      .pipe(
        tap(() => this.invalidateCache()),
        catchError(this.handleError)
      );
  ...
  suggestTimeSlots(
    ...
    return this.http
      .post<any[]>(`${this.API_URL}/suggest-slots`, { juryIds, dateRange })
      .pipe(catchError(this.handleError));
  }
  ...
  validateInterview(
    ...
    return this.http
      .post<{ valid: boolean; errors?: string[] }>(`${this.API_URL}/validate`, interview)
      .pipe(catchError(this.handleError));
  }
  ...
  getInterviewsByEmail(candidateEmail: string): Observable<Interview[]> {
    return this.http.get<Interview[]>(`${this.API_URL}/getInterviewsByEmail/${candidateEmail}`);
  }
}
