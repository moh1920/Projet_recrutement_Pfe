  ...
  private mockOffers: JobOffer[] = [
    {
      ...
      description:
        'Nous recherchons un docteur en informatique pour assurer des cours de développement avancé et encadrer des PFE.',
      requirements: [
        'Doctorat en Informatique',
        'Expérience académique > 2 ans',
        'Maîtrise de Spring Boot & Angular',
      ],
    ...
    },
    {
      ...
      location: 'ESPRIT Ghazela',
      description:
        'Contribution aux activités du laboratoire de recherche et enseignement en sécurité réseaux.',
